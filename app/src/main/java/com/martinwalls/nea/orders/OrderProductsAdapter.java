...
public class OrderProductsAdapter extends RecyclerView.Adapter<OrderProductsAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int position) {
        ...
        viewHolder.mass.setText(viewHolder.mass.getContext().getString(R.string.amount_kg, productQuantity.getQuantityMass()));
        if (productQuantity.getQuantityBoxes() >= 0) {
            viewHolder.numBoxes.setText(viewHolder.numBoxes.getContext().getResources()
                    .getQuantityString(R.plurals.amount_boxes, productQuantity.getQuantityBoxes(), productQuantity.getQuantityBoxes()));
        } else {
