...
public class AddLocationAction extends UndoableAction {
    ...
    public void showUndoMessage(Context context) {
        showUndoSnackbar(context, context.getString(
                R.string.undo_add_location_success, location.getLocationName()));
    }
    ...
    public void showRedoMessage(Context context) {
        showRedoSnackbar(context, context.getString(
                R.string.redo_add_location_success, location.getLocationName()));
    }
}
